...
import sion.my.caipiao.bean.Userinfo;
import sion.my.caipiao.databinding.FragmentMyselfBinding;
import sion.my.caipiao.sql.SqlHelper;
...
public class Fragment_myself extends Fragment implements View.OnClickListener {
    ...
    public void ShowDialog() {
        ...
        AlertDialog alertDialog = new AlertDialog.Builder(activity).setView(view).show();
        EditText editText[] = {viewHolder.name, viewHolder.psw, viewHolder.psw2};
